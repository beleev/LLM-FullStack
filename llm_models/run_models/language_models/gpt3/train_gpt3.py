...
def main():
    ...
    vocab_size = 1000
    model = GPT3(
        vocab_size=vocab_size, d_model=256, n_heads=4, num_layers=2, max_len=128, dropout=0.0,
    )
    print(f"GPT-3 Mini | 参数量: {sum(p.numel() for p in model.parameters()):,}")
