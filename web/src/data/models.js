...
export const stages = [
  ...
  },
  {
    ...
    idx: 2,
    code: 'llm_models/',
    title: '架构家族 · Transformer / MoE / 多模态',
...
export const learningPath = [
  ...
  ...stages.flatMap(s => [
    ...(s.route ? [{ route: s.route, label: s.title }] : []),
